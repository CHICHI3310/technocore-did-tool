...
const i18n = {
  en: {
    ...
    shareText: "Copy a simple post for X or your guide.",
    copyShare: "Copy share text",
    openX: "Open X composer",
    exportTitle: "Public proof export",
    exportText: "Share this public proof. Do not share the private key file.",
    ...
    profileHelp: "World-readable profile note. It links your DID, mailbox, and contribution record.",
  ...
  tr: {
    ...
    shareTitle: "Paylaşım kiti",
    shareText: "X veya rehberin için sade bir metin kopyala.",
    copyShare: "Paylaşım metnini kopyala",
    openX: "X composer aç",
    exportTitle: "Public proof export",
    exportText: "Bu public proof'u paylasabilirsin. Private key dosyasini paylasma.",
    ...
    profileHelp: "World-readable profile note. DID, mailbox ve katkı kaydını birbirine bağlar.",
